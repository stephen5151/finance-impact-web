...
function systemPrompt(): string {
  return [
    ...
    "6. 部分新闻原文是英文，请理解后用流畅的简体中文撰写全部内容（标题、摘要、推演），不要直接照搬英文。",
    "7. 对象国家只要中国：只挑选最终会影响到中国年轻人生活的事件。事件主体在中国（如中国政策、国内数据）当然要选；",
    "   主体在境外、但会沿传导链最终影响到中国的事件也要选（例如美国战争推高全球油价、美联储加息抬升全球资金成本、",
    "   海外通胀等——它们都会传导到中国）。请在 transmissionPath 中显式写出「传导到中国」这一步。",
    "   只丢弃那些纯属境外、和中国没有合理影响路径的本地新闻。",
    "",
